...
if selected == "Principal":
  ...
  with tab1:
    ...
    data['Casos por fecha de toma de muestra'].plot(marker='o', linestyle='None', markersize=3, label='Casos por fecha de toma de muestra')
    data['Casos por fecha de emisión de resultados'].plot(marker='o', linestyle='None', markersize=3, label='Casos por fecha de emisión de resultados')
    plt.xlabel("Fecha")

...
if selected == "Principal":
  ...
  with tab1:
    ...
    data['Casos por fecha de inicio de síntomas'].plot(marker='o', linestyle='None', markersize=3, label='Casos por fecha de inicio de síntomas')
    data['Casos por fecha de toma de muestra'].plot(marker='o', linestyle='None', markersize=3, color='lightblue', label='Casos por fecha de toma de muestra')
    data['Casos por fecha de emisión de resultados'].plot(marker='o', linestyle='None', markersize=3, color='lightpink', label='Casos por fecha de emisión de resultados')
    plt.xlabel("Fecha")
  ...
  with tab3:
    fig, ax = plt.subplots(figsize=(10, 6))
    data['Casos por fecha de toma de muestra'].plot(marker='o', linestyle='None', markersize=3, color='lavender', label='Casos por fecha de toma de muestra')
    plt.xlabel("Fecha")
    plt.ylabel("Número de casos")
    plt.legend()
    st.pyplot(fig)

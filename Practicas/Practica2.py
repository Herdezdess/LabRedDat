...
if selected == "Principal":
  #título
  st.markdown("<h1 style='text-align: center; color: #A2BDF1; text-shadow: 3px 3px #BEFBB3;'>--- Predicción de COVID19 ---</h1>", unsafe_allow_html=True)
  st.divider()
...
if selected == "Teoría":
  st.divider()
  st.markdown("""Práctica 2. Laboratorio de reducción de datos.""")
